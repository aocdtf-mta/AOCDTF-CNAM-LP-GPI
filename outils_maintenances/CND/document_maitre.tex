...
\formation{Licence GPI}
\matiere{Outils de la maintenance}
\cours{Outils de contrôle}

\auteura{Bruno}{Douchy}
\acronymemetierauteura{MTA}
\auteurb{Christelle}{Gaches}
\acronymemetierauteurb{MTA}
\auteurc{}{}
